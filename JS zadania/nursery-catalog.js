...
const displayPlantsSet = () => {
    const plantKeys = Array.from(catalog.keys());
    const commonNames = plantKeys.map(plant => plant.commonName); 
    const uniqueCommonNamesSet = new Set(commonNames); 
    return uniqueCommonNamesSet;
};
